      ...
      <section className="story-section">
        ...
        src="images/section_delimiter_1.png" alt="img" class="section_devider"/>
          ...
          care and tradition. Since our establishment in [year], we have grown to become a trusted name in the food production
           industry. Our diverse product range includes ginger-garlic paste, custard apple pulp, traditional Indian dry chutneys, 
           fresh green peas, and fresh peanut and kardi oils and many more.
          </p>
          <p>
          We take pride in serving over 1500+ loyal customers and have successfully expanded our reach to more than 28+ cities across
           India. With an annual turnover of ₹[Enter Turnover Amount] and an impressive 89% repeat customer rate, we continue to
            build lasting relationships by delivering authentic and healthy flavors. Our team is dedicated to sourcing ingredients
             sustainably, supporting local farmers, and ensuring the highest standards of quality at every step of the production 
             process. At Aditya Food's, we strive to bring natural goodness to your table.
          </p>
        </div>
